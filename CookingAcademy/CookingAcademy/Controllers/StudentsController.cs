...
namespace CookingAcademy
{
    public class StudentsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "StudentID,PersonId,Major,Active")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "StudentID,PersonId,Major,Active")] Student student)
        {
            if (ModelState.IsValid)
            {
